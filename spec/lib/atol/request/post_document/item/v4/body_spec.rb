...
require './lib/atol/request/post_document/item/v4/body'
...
RSpec.describe Atol::Request::PostDocument::Item::V4::Body do
  ...
  context 'when bad payment_method given' do
    ...
    it 'raise error' do
      expect { body_hash }.to raise_error(
        Atol::Request::PostDocument::Item::V4::Body::BadPaymentMethodError
      )
    end
  end
  ...
  context 'when bad payment_object given' do
    ...
    it 'raise error' do
      expect { body_hash }.to raise_error(
        Atol::Request::PostDocument::Item::V4::Body::BadPaymentObjectError
      )
    end
  end
end
